...
const resources = {
  ...
  pt: {
    translation: {
      welcomeMessage: "Este é um espaço dedicado à apresentação dos portfólios dos alunos do IBMEC. Aqui, você pode conhecer os projetos criados por nossos estudantes, que refletem suas competências, criatividade e trajetória acadêmica. Explore e descubra o talento e a inovação que emergem em nosso campus!",
